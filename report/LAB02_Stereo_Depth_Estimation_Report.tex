...
The repository includes the official OpenCV sample images \texttt{aloeL.jpg} and \texttt{aloeR.jpg} in the \texttt{data/} directory. The images are two views of the same static scene and have identical dimensions.
...
Repository Cleanup & \texttt{a3e9ac7} -- Remove redundant setup and temporary files \\
\end{tabular}
